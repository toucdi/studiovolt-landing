...
const icons = [
  ...
  <svg key="performance" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <svg key="seo" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
  </svg>,
  <svg key="privacy" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
  </svg>,
  <svg key="service" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="container-minimal">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-medium tracking-tighter text-black">
            {dict.services.title}
            <br />
            <span className="text-slate-200">{dict.services.titleGray}</span>
          </h2>
        </motion.div>
