    ...
    <section id="servizi" className="section-padding bg-white border-t border-slate-100">
      <div className="container-minimal">
        <motion.div
          ...
          className="mb-24"
        >
          <span className="text-sm font-medium tracking-[0.2em] uppercase text-muted mb-4 block">Cosa fanno gli agenti</span>
          <h2 className="text-4xl md:text-5xl font-medium tracking-tighter text-black">
            Lavoro reale,
            <br />
            <span className="text-slate-200">non demo.</span>
          </h2>
        </motion.div>
